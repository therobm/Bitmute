...
namespace Bitmute.UI
{
	public class ToolPalette : ContentView
	{
		...
		public ToolPalette()
		{
			m_tools = new eTool[] { eTool.Move, eTool.Select, eTool.EllipseSelect, eTool.Lasso, eTool.MagicWand, eTool.Pencil, eTool.Brush, eTool.Eraser, eTool.Fill, eTool.Eyedropper, eTool.Text, eTool.Line, eTool.DodgeBurn, eTool.Zoom };
			m_glyphs = new string[] { "✛︎", "⬚", "◯", "⬠", "✦︎", "✎︎", "▨", "▭", "▣", "◉", "T", "╱", "◐", "◎" };
			m_names = new string[] { "Move", "Rectangle Select", "Ellipse Select", "Poly Lasso", "Magic Wand", "Pencil", "Brush", "Eraser", "Fill", "Eyedropper", "Text", "Line", "Dodge / Burn (Alt = Burn)", "Zoom" };
