...
namespace Bitmute.UI
{
	public class ToolPalette : ContentView
	{
		...
		public ToolPalette()
		{
			m_tools = new eTool[] { eTool.Move, eTool.Select, eTool.MagicWand, eTool.Pencil, eTool.Brush, eTool.Eraser, eTool.Fill, eTool.Eyedropper, eTool.Text, eTool.Zoom };
			m_glyphs = new string[] { "✛︎", "⬚", "✦︎", "✎︎", "▨", "▭", "▣", "◉", "T", "◎" };
			m_names = new string[] { "Move", "Rectangle Select", "Magic Wand", "Pencil", "Brush", "Eraser", "Fill", "Eyedropper", "Text", "Zoom" };
