...
namespace Bitmute.UI
{
	public class ToolPalette : ContentView
	{
		...
		public ToolPalette()
		{
			...
			m_icons = new string[] { "move.png", "box_select.png", "ellipse_select.png", "lasso.png", "magic_wand.png", "pencil.png", "brush.png", "eraser.png", "clone.png", "fill.png", "fill.png", "eyedropper.png", "text.png", "line.png", "crop.png", "crop.png", "ellipse_select.png", "magic_wand.png", "blur.png", "sharpen.png", "smudge.png", "dodge.png", "hand.png", "zoom.png" };
